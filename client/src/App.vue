  ...
  <v-app style="background: #E3E3EE">
    ...
    >
      ...
      >
        ...
        >
          <h1 class="title pl-3">DevRoads</h1>
        </router-link>
      </v-toolbar>
...
export default {
  ...
  computed: {
    ...
    horizontalNavItems() {
      let items = [
        { icon: "chat", title: "Курсы", link: "/courses" },
        { icon: "lock_open", title: "Войти", link: "/signin" },
        { icon: "create", title: "Регистрация", link: "/signup" }
      ];
      if (this.user) {
        items = [{ icon: "chat", title: "Курсы", link: "/courses" }];
      }
      return items;
    },
    sideNavItems() {
      ...
      if (this.user) {
        items = [
          { icon: "chat", title: "Курсы", link: "/courses" },
          { icon: "stars", title: "Создать курс", link: "/course/add" },
          { icon: "account_box", title: "Профиль", link: "/profile" }
        ];
      }
      return items;
    }
  ...
  methods: {
    ...
    goToSearchResult(resultId) {
      ...
      this.$router.push(`/courses/${resultId}`);
